...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/VHDL-RISC-V/ip/blk_mem_gen_0/blk_mem_gen_0.xci"]"\
 "[file normalize "$origin_dir/VHDL-RISC-V/src/Conditioning_Unit_64bit.vhd"]"\
 "[file normalize "$origin_dir/VHDL-RISC-V/src/Flag_Detection_unit_64bit.vhd"]"\
 "[file normalize "$origin_dir/VHDL-RISC-V/src/Logic_Unit_64bit.vhd"]"\
  ]
  foreach ifile $files {
...
set files [list \
 [file normalize "${origin_dir}/VHDL-RISC-V/VHDL-RISC-V.srcs/sources_1/ip/blk_mem_gen_0/blk_mem_gen_0.xci" ]\
 [file normalize "${origin_dir}/VHDL-RISC-V/VHDL-RISC-V.srcs/sources_1/imports/src/Conditioning_Unit_64bit.vhd"]\
 [file normalize "${origin_dir}/VHDL-RISC-V/VHDL-RISC-V.srcs/sources_1/imports/src/Flag_Detection_unit_64bit.vhd"]\
 [file normalize "${origin_dir}/VHDL-RISC-V/VHDL-RISC-V.srcs/sources_1/imports/src/Logic_Unit_64bit.vhd"]\
]
set imported_files ""
foreach f $files {
...
set file "src/Conditioning_Unit_64bit.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "src/Flag_Detection_unit_64bit.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "src/Logic_Unit_64bit.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
