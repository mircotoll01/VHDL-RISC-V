...
#
# Generated by Vivado on Sun May 04 14:33:31 CEST 2025
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/VHDL-RISC-V/VHDL-RISC-V.srcs/sources_1/new/write_back.vhd"]"\
  ]
  foreach ifile $files {
 ...
 "[file normalize "$origin_dir/ip/data_memory/data_memory.xci"]"\
...
set file "$origin_dir/ip/data_memory/data_memory.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
